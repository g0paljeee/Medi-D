...
public class DataLoader implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        // 2. Create a Patient
        Patient patient = new Patient(null, "Munna Kumar", "Medical History: Type 2 Diabetes, Allergic to Penicillin");
        ...
        appt.setDoctorId(101L); // Dummy Doctor ID
        appt.setPatient(patient); // Link to Munna Kumar
        ...
        System.out.println("   - Appointment: Booked for Doctor 101");
    }
}